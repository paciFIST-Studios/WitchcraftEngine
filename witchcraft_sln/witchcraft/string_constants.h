...
namespace witchcraft
{
	...
	namespace log_strings
	{
		...
		static char const * audio_manager_ok  = "audio manager ok";
		static char const * audio_device_init = "audio device init";
		static char const * audio_device_ok   = "audio device ok";

		static char const * debug_console_start = "debug console start";
		static char const * debug_console_ok	= "debug console ok";

		static char const * engine_start	= "engine start";
		static char const * engine_ready	= "engine ready";
		...
		static char const * engine_ok		= "engine ok";
		...
		static char const * message_bus_ok	  = "message bus ok";
		...
		static char const * project_loader_ok	 = "project loader ok";
		...
		static char const * scene_manager_ok	= "scene manager ok";
